...
export interface ApiCommunityCommunity extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'Research communities on the platform';
  ...
  attributes: {
    ...
    forumCategories: Schema.Attribute.Relation<
      'oneToMany',
...
export interface ApiForumCategoryForumCategory
  ...
  info: {
    description: 'Categories for forum threads';
...
export interface ApiInstitutionInstitution extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    affiliationType: Schema.Attribute.Enumeration<
      ['University', 'Research Org', 'Funding Agency', 'Other']
    >;
...
export interface ApiMentorshipRequestMentorshipRequest
  ...
  info: {
    description: 'A request from a mentee to a mentor';
...
export interface ApiOrcidOrcid extends Struct.SingleTypeSchema {
  collectionName: 'orcids';
  info: {
    description: 'Utility API for ORCID integration';
    displayName: 'ORCID Configuration';
    pluralName: 'orcids';
    singularName: 'orcid';
  };
  options: {
  ...
  attributes: {
    ...
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    description: Schema.Attribute.String &
      Schema.Attribute.DefaultTo<'Configuration for ORCID integration'>;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::orcid.orcid'> &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
...
export interface ApiPostPost extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::post.post'> &
      Schema.Attribute.Private;
    parentPost: Schema.Attribute.Relation<'manyToOne', 'api::post.post'>;
    publishedAt: Schema.Attribute.DateTime;
    replies: Schema.Attribute.Relation<'oneToMany', 'api::post.post'>;
...
export interface ApiResourceResource extends Struct.CollectionTypeSchema {
  ...
  info: {
    description: 'User-submitted resources and toolkits';
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<
      ['Toolkit', 'Story', 'Training', 'Dataset', 'Other']
    > &
      Schema.Attribute.Required;
    community: Schema.Attribute.Relation<
      'manyToOne',
    ...
    > &
      Schema.Attribute.Private;
    publishedAt: Schema.Attribute.DateTime;
    rejectionNotes: Schema.Attribute.Text;
...
export interface ApiThreadThread extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    followers: Schema.Attribute.Relation<
      ...
      'plugin::users-permissions.user'
    >;
    forumCategory: Schema.Attribute.Relation<
      'manyToOne',
      'api::forum-category.forum-category'
    >;
...
export interface PluginUsersPermissionsUser
  ...
  attributes: {
    affiliationStatus: Schema.Attribute.Enumeration<
      ['Pending', 'Approved', 'Rejected']
    > &
      Schema.Attribute.DefaultTo<'Pending'>;
    blocked: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    careerStage: Schema.Attribute.Enumeration<
    ...
    followedThreads: Schema.Attribute.Relation<
      'manyToMany',
      'api::thread.thread'
    >;
    ...
    > &
      Schema.Attribute.Private;
    mentorAvailability: Schema.Attribute.Boolean &
      Schema.Attribute.DefaultTo<false>;
    mentorshipRequestsReceived: Schema.Attribute.Relation<
      'oneToMany',
      'api::mentorship-request.mentorship-request'
    >;
    mentorshipRequestsSent: Schema.Attribute.Relation<
      'oneToMany',
      'api::mentorship-request.mentorship-request'
    >;
    onboardingStep: Schema.Attribute.Integer & Schema.Attribute.DefaultTo<0>;
    orcidId: Schema.Attribute.String;
    orcidVerified: Schema.Attribute.Boolean & Schema.Attribute.DefaultTo<false>;
    password: Schema.Attribute.Password &
      Schema.Attribute.Private &
      Schema.Attribute.SetMinMaxLength<{
        minLength: 6;
