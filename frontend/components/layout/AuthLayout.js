  ...
  return (
    <div className="min-h-screen flex flex-col md:flex-row bg-white">
      ...
      <div className="hidden md:flex md:w-1/2 lg:w-[55%] bg-brand-primary p-12 lg:p-20 relative overflow-hidden items-center justify-center">
        ...
        <div className="absolute inset-0 bg-linear-to-br from-primary-900/80 to-brand-teal-900/60"></div>
        ...
        <div className="relative z-10 max-w-lg text-white">
          ...
          <p className="text-xl text-primary-50/90 leading-relaxed font-medium">
            Join the community of scientists, researchers, and innovators
            building a sustainable scientific ecosystem across the continent.
          </p>
          ...
          <div className="mt-12 flex gap-4 items-center">
            <div className="flex -space-x-4">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="h-12 w-12 rounded-full border-2 border-primary-800 bg-primary-700 flex items-center justify-center text-xs font-bold ring-2 ring-primary-900/50"
                >
