...
2. Detect the current stack by checking the directory name and its `.agent/rules/`. Respect stack-specific testing strategies and tools (e.g., `docker compose exec backend npm test`).
