...
function SelectTrigger({
  ...
  if (asChild) {
    return <SelectPrimitive.Trigger render={children} {...triggerProps} />;
  }
...
function SelectItem({ className, children, ...props }) {
  return (
    <SelectPrimitive.Item
      ...
      className={cn(
        "relative flex w-full cursor-default h-[42px] items-center gap-2 rounded-md px-2 text-base font-heading font-medium tracking-wider outline-none select-none focus:bg-brand-teal-50 focus:text-brand-teal-900 data-disabled:pointer-events-none data-disabled:opacity-50",
        className,
      )}
      {...props}
    >
