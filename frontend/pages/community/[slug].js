            ...
            >
              ...
              <TabsContent value="collaboration-calls" className="pt-2">
                <CollaborationCallsList
                  ...
                  onCreate={isAuthenticated && isMember ? openCollaboration : undefined}
                />
              </TabsContent>
              <TabsContent value="resources" className="pt-2">
                <ResourcesList
                  ...
                  sortOrder={sortOrder}
                  showAddButton={isAuthenticated && isMember}
                />
              </TabsContent>
            </Tabs>
          </div>
...
export async function getServerSideProps({ locale }) {
  return {
    props: {
      ...(await serverSideTranslations(locale, ["common", "community", "profile"])),
    },
  };
}
